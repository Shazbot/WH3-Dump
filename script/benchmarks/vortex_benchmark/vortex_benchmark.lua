...
function end_deployment_phase()
	...
	bm:callback(
		function()
			...
			bm:spawn_vortex("benchmark", v(-125.0, 0.0, -350.0), v(1.0, 0.0, 1.0))
	...
	-- bm:callback(
		-- function()
			...
			-- bm:spawn_vortex("test", v(-175.0, 0.0, -350.0), v(1.0, 0.0, 1.0))
	...
	bm:callback(
		function()
			...
			bm:spawn_vortex("benchmark_barrier", v(0.0, 0.0, -250.0), v(0.0, 0.0, 1.0))
	...
	bm:callback(
		function()
			...
			bm:spawn_vortex("benchmark", v(-105.0, 0.0, -325.0), v(1.0, 0.0, 1.0))
	...
	-- bm:callback(
		-- function()
			...
			-- spawn_vortex("test", v(50.0, 0.0, 100.0), v(1.0, 0.0, 1.0))
	...
	bm:callback(
		function()
			...
			bm:spawn_vortex("benchmark", v(-250.0, 0.0, -150.0), v(1.0, 0.0, 1.0))
	...
	bm:callback(
		function()
			...
			bm:spawn_vortex("benchmark", v(200.0, 0.0, -150.0), v(1.0, 0.0, 1.0))
			bm:spawn_vortex("benchmark", v(200.0, 0.0, -350.0), v(1.0, 0.0, 1.0))
