local minor_cult = {
	key = "",
	slot_key = "wh3_main_slot_set_minor_cult_1",
	...
	force_region = nil,
	valid_provinces = {
		["wh3_main_combi_province_eataine"] = true,
		["wh3_main_combi_province_caledor"] = true,
		["wh3_main_combi_province_tiranoc"] = true,
		["wh3_main_combi_province_ellyrion"] = true,
		["wh3_main_combi_province_nagarythe"] = true,
		["wh3_main_combi_province_avelorn"] = true,
		["wh3_main_combi_province_chrace"] = true,
		["wh3_main_combi_province_cothique"] = true,
		["wh3_main_combi_province_saphery"] = true,
		["wh3_main_combi_province_northern_yvresse"] = true,
		["wh3_main_combi_province_southern_yvresse"] = true
	},
	valid_from_turn = 5,
	chance_if_valid = 5,
