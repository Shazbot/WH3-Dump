local minor_cult = {
	...
	valid_provinces = {
		...
		["wh3_main_combi_province_western_oblast"] = true,
		["wh3_main_combi_province_southern_oblast"] = true,
		["wh3_main_combi_province_eastern_oblast"] = true,
		["wh3_main_chaos_province_northern_oblast"] = true,
		["wh3_main_combi_province_river_urskoy"] = true
	},
	valid_from_turn = 5,
	chance_if_valid = 5,
	event_data = nil,
