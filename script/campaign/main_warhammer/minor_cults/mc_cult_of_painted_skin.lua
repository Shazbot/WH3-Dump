local minor_cult = {
	...
	force_region = nil,
	valid_provinces = {
		["wh3_main_combi_province_imperial_road"] = true,
		["wh3_main_combi_province_forests_of_the_moon"] = true,
		["wh3_main_combi_province_plains_of_xen"] = true,
		["wh3_main_combi_province_lands_of_stone_and_steel"] = true,
		["wh3_main_combi_province_gunpowder_road"] = true,
		["wh3_main_combi_province_celestial_riverlands"] = true,
		["wh3_main_combi_province_the_great_canal"] = true,
		["wh3_main_combi_province_serpent_estuary"] = true,
		["wh3_main_combi_province_mount_li"] = true,
		["wh3_main_combi_province_celestial_lake"] = true,
		["wh3_main_combi_province_nongchang_basin"] = true
	},
	valid_from_turn = 5,
	chance_if_valid = 5,
	event_data = nil,
