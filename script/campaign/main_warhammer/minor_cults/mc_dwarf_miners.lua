local minor_cult = {
	...
	event_data = {event_chance_per_turn = 5, event_cooldown = 25, event_limit = 5, event_initial_delay = 5, force_trigger = false},
...
function minor_cult:custom_listeners()
	core:add_listener(
		...
		true,
		function(context)
			if context:dilemma() == "wh3_main_minor_cult_earthquake" then
