local minor_cult = {
	key = "",
	slot_key = "wh3_main_slot_set_minor_cult_33",
	...
	force_region = nil,
	valid_provinces = {
		["wh3_main_combi_province_iron_foothills"] = true,
		["wh3_main_combi_province_the_black_flood"] = true,
		["wh3_main_combi_province_obsidian_peaks"] = true,
		["wh3_main_combi_province_iron_mountains"] = true,
		["wh3_main_combi_province_iron_coast"] = true,
		["wh3_main_combi_province_spiteful_peaks"] = true,
		["wh3_main_combi_province_the_road_of_skulls"] = true,
		["wh3_main_combi_province_red_desert"] = true,
		["wh3_main_combi_province_doom_glades"] = true
	},
	valid_from_turn = 5,
	chance_if_valid = 5,
