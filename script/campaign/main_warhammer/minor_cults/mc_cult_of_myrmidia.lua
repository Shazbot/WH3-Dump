local minor_cult = {
	key = "",
	slot_key = "wh3_main_slot_set_minor_cult_10",
	intro_incident_key = "wh3_main_minor_cult_intro",
	effect_bundle = "wh3_main_minor_cult_myrmidia",
	valid_subcultures = {
...
function minor_cult:removal_event(remover, region)
	local remover_cqi = remover:command_queue_index();
	local region_cqi = region:cqi();
	cm:trigger_incident_with_targets(remover_cqi, "wh3_main_minor_cult_myrmidia", 0, 0, 0, 0, region_cqi, 0);
