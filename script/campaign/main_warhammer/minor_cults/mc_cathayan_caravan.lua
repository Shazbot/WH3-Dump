local minor_cult = {
	key = "",
	slot_key = "wh3_main_slot_set_minor_cult_30",
	...
	event_data = {event_chance_per_turn = 30, event_cooldown = 1, event_limit = 1, event_initial_delay = 3, force_trigger = false},
	saved_data = {status = 0, region_key = "", event_cooldown = 0, event_triggers = 0}
};

function minor_cult:removal_event(remover, region)
	cm:trigger_dilemma_with_targets(remover:command_queue_index(), "wh3_main_minor_cult_cathay_caravan_removed", 0, 0, 0, 0, region:cqi(), 0);
