...
out.narrative("* wh3_narrative_vampire_counts.lua loaded");
...
local function start_vampire_counts_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh_main_vmp_vampire_counts", start_vampire_counts_narrative_events);