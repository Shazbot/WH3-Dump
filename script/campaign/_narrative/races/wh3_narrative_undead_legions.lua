...
out.narrative("* wh3_narrative_undead_legions.lua loaded");
...
local function start_undead_legions_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh3_dlc29_nag_undead_legions", start_undead_legions_narrative_events);