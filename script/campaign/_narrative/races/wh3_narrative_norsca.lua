...
out.narrative("* wh3_narrative_norsca.lua loaded");
...
local function start_norsca_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh_dlc08_nor_norsca", start_norsca_narrative_events);