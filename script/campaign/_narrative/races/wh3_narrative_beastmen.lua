...
out.narrative("* wh3_narrative_beastmen.lua loaded");
...
local function start_beastmen_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh_dlc03_bst_beastmen", start_beastmen_narrative_events);