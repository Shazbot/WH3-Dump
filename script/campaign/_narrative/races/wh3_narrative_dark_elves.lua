...
out.narrative("* wh3_narrative_dark_elves.lua loaded");
...
local function start_dark_elves_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh2_main_def_dark_elves", start_dark_elves_narrative_events);