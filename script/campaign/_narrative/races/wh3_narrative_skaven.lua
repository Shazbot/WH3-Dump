...
out.narrative("* wh3_narrative_skaven.lua loaded");
...
local function start_skaven_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh2_main_skv_skaven", start_skaven_narrative_events);