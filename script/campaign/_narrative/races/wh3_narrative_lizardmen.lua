...
out.narrative("* wh3_narrative_lizardmen.lua loaded");
...
local function start_lizardmen_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh2_main_lzd_lizardmen", start_lizardmen_narrative_events);