...
out.narrative("* wh3_narrative_bretonnia.lua loaded");
...
local function start_bretonnia_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh_main_brt_bretonnia", start_bretonnia_narrative_events);