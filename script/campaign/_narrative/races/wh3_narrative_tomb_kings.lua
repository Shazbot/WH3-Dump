...
out.narrative("* wh3_narrative_tomb_kings.lua loaded");
...
local function start_tomb_kings_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh2_dlc09_tmb_tomb_kings", start_tomb_kings_narrative_events);