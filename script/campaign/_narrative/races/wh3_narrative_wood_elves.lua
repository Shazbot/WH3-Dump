...
out.narrative("* wh3_narrative_wood_elves.lua loaded");
...
local function start_wood_elves_narrative_events(faction_key)

end;


-- Ensure that these narrative events are started for any player-controlled faction matching the culture
narrative.add_loader_for_culture("wh_dlc05_wef_wood_elves", start_wood_elves_narrative_events);