...
recruited_unit_health.units_to_starting_health_bonus_values = {
	...
	wh3_dlc29_chs_inf_putrid_blightkings_axe_shield 	= "recruit_hp_inf_putrid_blightkings_axe_shield",
	wh3_dlc29_chs_inf_putrid_blightkings_dual_axe 		= "recruit_hp_inf_putrid_blightkings_dual_axe",
	wh3_dlc29_chs_inf_putrid_blightkings_great_weapons 	= "recruit_hp_inf_putrid_blightkings_great_weapons",
}
