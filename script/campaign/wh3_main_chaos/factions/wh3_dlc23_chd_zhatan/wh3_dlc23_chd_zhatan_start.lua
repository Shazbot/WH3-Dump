...
if cm:is_new_game() then
	...
	local cindy_scene_key = "chd_zhatan";

	local advice_to_play = {
		"wh3_camp_realm_of_chaos_zhatan_intro_001",
		"wh3_camp_realm_of_chaos_zhatan_intro_002",
		"wh3_camp_realm_of_chaos_zhatan_intro_003",
		"wh3_camp_realm_of_chaos_zhatan_intro_004",
		"wh3_camp_realm_of_chaos_zhatan_intro_005",
	};
	...
	local fullscreen_movie = "warhammer3/chd/dlc23_zhatan_intro";
