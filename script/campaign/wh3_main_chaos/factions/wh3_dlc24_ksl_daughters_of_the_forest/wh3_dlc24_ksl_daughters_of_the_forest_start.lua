...
if cm:is_new_game() then
	local faction_key = "wh3_dlc24_ksl_daughters_of_the_forest";
	...
	local cindy_scene_key = "ksl_motherostankya";

	local advice_to_play = {
		"wh3_camp_realm_of_chaos_mother_ostankya_intro_001",
		"wh3_camp_realm_of_chaos_mother_ostankya_intro_002",
		"wh3_camp_realm_of_chaos_mother_ostankya_intro_003",
		"wh3_camp_realm_of_chaos_mother_ostankya_intro_004",
		"wh3_camp_realm_of_chaos_mother_ostankya_intro_005"
	};
	...
	local fullscreen_movie = "warhammer3/ksl/mother_ostankya_intro";
