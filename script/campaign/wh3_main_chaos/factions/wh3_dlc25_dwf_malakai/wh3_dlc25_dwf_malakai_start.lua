...
if cm:is_new_game() then
	local faction_key = "wh3_dlc25_dwf_malakai";
	...
	local cindy_scene_key = "dwf_malakai";

	local advice_to_play = {
		"wh3_camp_realm_of_chaos_malakai_makaisson_intro_001",
		"wh3_camp_realm_of_chaos_malakai_makaisson_intro_002",
		"wh3_camp_realm_of_chaos_malakai_makaisson_intro_003",
		"wh3_camp_realm_of_chaos_malakai_makaisson_intro_004",
		"wh3_camp_realm_of_chaos_malakai_makaisson_intro_005",
	};
	...
	local fullscreen_movie = "warhammer3/dwf/malakai_intro";
