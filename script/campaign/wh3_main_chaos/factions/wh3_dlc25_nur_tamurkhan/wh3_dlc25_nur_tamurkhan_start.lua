...
if cm:is_new_game() then
	local faction_key = "wh3_dlc25_nur_tamurkhan";
	...
	local cindy_scene_key = "nur_tamurkhan";

	local advice_to_play = {
		"wh3_camp_realm_of_chaos_tamurkhan_intro_001",
		"wh3_camp_realm_of_chaos_tamurkhan_intro_002",
		"wh3_camp_realm_of_chaos_tamurkhan_intro_003",
		"wh3_camp_realm_of_chaos_tamurkhan_intro_004",
		"wh3_camp_realm_of_chaos_tamurkhan_intro_005",
	};
	...
	local fullscreen_movie = "warhammer3/nur/tamurkhan_intro";
