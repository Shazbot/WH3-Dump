...
wh3_intro_sfx_03 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_intro_003");
wh3_intro_sfx_04 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_intro_004");
...
function play_intro_cutscene()
	...
	-- But let them laugh! Once we claim enough of the Altar’s Marks of Power, no challenger can stop us from taking the Bloodfather’s dues!
	cutscene_intro:add_cinematic_trigger_listener(
	...
	-- The sluts of Slaanesh cannot contain their fear at the Bloodfather’s rise! 
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_valkia_altar_of_battle_intro_04", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_04);
				bm:show_subtitle("wh3_dlc20_qb_valkia_altar_of_battle_intro_04", false, true);
			end
	);

	-- Their debauch ways will be a mere sideshow to the world’s ruin; in the end, there can only be murder!
	cutscene_intro:add_cinematic_trigger_listener(
