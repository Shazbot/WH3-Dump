...
intro_cinematic_file = "script\\battle\\survival_battles\\_cutscene\\managers\\mom_trial05_m01.CindySceneManager";
...
wh3_intro_sfx_00 = new_sfx("Play_Movie_WH3_DLC23_MOM_QB05_Realm_Of_Tzeentch_Sweetener");

wh3_intro_sfx_01 = new_sfx("Play_wh3_MirrorsOfMadness_Narrator_Realm_of_Tzeentch_01");
wh3_intro_sfx_02 = new_sfx("Play_wh3_MirrorsOfMadness_Narrator_Realm_of_Tzeentch_02");
wh3_intro_sfx_03 = new_sfx("Play_wh3_MirrorsOfMadness_Narrator_Realm_of_Tzeentch_03");
wh3_intro_sfx_04 = new_sfx("Play_wh3_MirrorsOfMadness_Narrator_Realm_of_Tzeentch_04");
...
function play_intro_cutscene()
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"Play_wh3_MirrorsOfMadness_Narrator_Realm_of_Tzeentch_01", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_01);
				bm:show_subtitle("wh3_mom_intro_realm_of_tzeentch_01", false, true);
			end
	);

	cutscene_intro:add_cinematic_trigger_listener(
		"Play_wh3_MirrorsOfMadness_Narrator_Realm_of_Tzeentch_02", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_02);
				bm:show_subtitle("wh3_mom_intro_realm_of_tzeentch_02", false, true);
			end
	);

	cutscene_intro:add_cinematic_trigger_listener(
		"Play_wh3_MirrorsOfMadness_Narrator_Realm_of_Tzeentch_03", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_03);
				bm:show_subtitle("wh3_mom_intro_realm_of_tzeentch_03", false, true);
			end
	);

	cutscene_intro:add_cinematic_trigger_listener(
		"Play_wh3_MirrorsOfMadness_Narrator_Realm_of_Tzeentch_04", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_04);
				bm:show_subtitle("wh3_mom_intro_realm_of_tzeentch_04", false, true);
			end
	);
...
gb:set_objective_on_message("cutscene_intro", "wh3_pro10_mom_qb_05_realm_of_tzeentch_hints_main_objective");
...
local speed_04 = 13000;
local speed_05 = 16000;
local speed_06 = 50000;
