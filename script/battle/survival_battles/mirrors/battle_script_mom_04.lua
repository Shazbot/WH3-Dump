...
intro_cinematic_file = "script\\battle\\survival_battles\\_cutscene\\managers\\mom_trial04_m01.CindySceneManager";
...
wh3_intro_sfx_00 = new_sfx("Play_Movie_WH3_DLC23_MOM_QB04_Altar_Of_Ultimate_Darkness_Sweetener");

wh3_intro_sfx_01 = new_sfx("Play_wh3_MirrorsOfMadness_Narrator_Altar_of_Ultimate_Darkness_01");
wh3_intro_sfx_02 = new_sfx("Play_wh3_MirrorsOfMadness_Narrator_Altar_of_Ultimate_Darkness_02");
wh3_intro_sfx_03 = new_sfx("Play_wh3_MirrorsOfMadness_Narrator_Altar_of_Ultimate_Darkness_03");
wh3_intro_sfx_04 = new_sfx("Play_wh3_MirrorsOfMadness_Narrator_Altar_of_Ultimate_Darkness_04");
...
function play_intro_cutscene()
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"Play_wh3_MirrorsOfMadness_Narrator_Altar_of_Ultimate_Darkness_01", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_01);
				bm:show_subtitle("wh3_mom_intro_altar_of_ultimate_darkness_01", false, true);
			end
	);

	cutscene_intro:add_cinematic_trigger_listener(
		"Play_wh3_MirrorsOfMadness_Narrator_Altar_of_Ultimate_Darkness_02", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_02);
				bm:show_subtitle("wh3_mom_intro_altar_of_ultimate_darkness_02", false, true);
			end
	);

	cutscene_intro:add_cinematic_trigger_listener(
		"Play_wh3_MirrorsOfMadness_Narrator_Altar_of_Ultimate_Darkness_03", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_03);
				bm:show_subtitle("wh3_mom_intro_altar_of_ultimate_darkness_03", false, true);
			end
	);

	cutscene_intro:add_cinematic_trigger_listener(
		"Play_wh3_MirrorsOfMadness_Narrator_Altar_of_Ultimate_Darkness_04", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_04);
				bm:show_subtitle("wh3_mom_intro_altar_of_ultimate_darkness_04", false, true);
			end
	);
...
gb:set_objective_on_message("cutscene_intro", "wh3_pro10_mom_qb_04_altar_of_ultimate_darkness_hints_main_objective");
...
local speed_04 = 13500;
local speed_05 = 17000;
local speed_06 = 60000;
