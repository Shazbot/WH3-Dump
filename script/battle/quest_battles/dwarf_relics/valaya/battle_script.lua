...
gb:queue_help_on_message("stir", "wh3_dlc23_chd_relic_of_valaya_02");
gb:queue_help_on_message("start_ambush", "wh3_dlc23_chd_relic_of_valaya_03");
...
ga_ai_01:rush_on_message("rush");

ga_ai_02:reinforce_on_message("start_ambush");
