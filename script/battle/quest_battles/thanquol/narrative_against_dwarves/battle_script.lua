...
-- Thanquol
-- By Hristo Enev
-- Narrative battle against Dwarves
...
ga_ai_dwf_main:force_victory_on_message("player_lost", 2500);

-------------------------------------------------------------------------------------------------
------------------------------------------- VICTORY ---------------------------------------------
-------------------------------------------------------------------------------------------------
ga_ai_dwf_main:message_on_casualties("player_wins", 0.95);
...
-------------ORDERS------------
-------------------------------
ga_ai_dwf_main:message_on_proximity_to_enemy("rush_on_being_attacked", 300);
ga_ai_dwf_main:message_on_under_attack("rush_on_being_attacked");
ga_ai_dwf_main:rush_on_message("rush_on_being_attacked");
