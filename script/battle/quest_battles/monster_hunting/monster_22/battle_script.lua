...
-----------------------------
gc:add_element("Play_dlc27_nor_monstrous_arcanum_battle_black_dragon_001_1", "dlc27_nor_monstrous_arcanum_battle_black_dragon_001", "army_pan_front_mid", 8000, true, false, true);
gc:add_element("Play_dlc27_nor_monstrous_arcanum_battle_black_dragon_002_1", "dlc27_nor_monstrous_arcanum_battle_black_dragon_002", "gc_orbit_90_medium_commander_front_right_close_low_01", 7000, true, false, false);
...
-----OBJECTIVE 1-----
--???
gb:set_objective_with_leader_on_message("objective_01", "wh3_dlc27_qb_monster_hunt_22_objective_01");
gb:complete_objective_on_message("black_dragon_boss_dead", "wh3_dlc27_qb_monster_hunt_22_objective_01");
gb:remove_objective_on_message("black_dragon_boss_dead", "wh3_dlc27_qb_monster_hunt_22_objective_01", 10000);

gb:queue_help_on_message("hint_01", "wh3_dlc27_qb_monster_hunt_22_hint_01");
gb:queue_help_on_message("black_dragon_boss_weak", "wh3_dlc27_qb_monster_hunt_22_hint_02");
...
gb:message_on_all_messages_received("enemy_forces_dead", "main_force_dead", "black_dragon_boss_dead")
...
ga_ai_enemy_main_boss:message_on_casualties("black_dragon_boss_weak",0.7);
ga_ai_enemy_main_boss:message_on_commander_death("black_dragon_boss_dead");

ga_ai_enemy_main_forces:attack_on_message("start");
ga_ai_enemy_main_forces:message_on_rout_proportion("main_force_dead",0.99);

gb:add_listener(
	"black_dragon_boss_weak",
	function()
