...
-----------------------------
gc:add_element("Play_dlc27_nor_monstrous_arcanum_battle_ghorgon_001_1", "dlc27_nor_monstrous_arcanum_battle_ghorgon_001", "army_pan_front_mid", 8000, true, false, true);
gc:add_element("Play_dlc27_nor_monstrous_arcanum_battle_ghorgon_002_1", "dlc27_nor_monstrous_arcanum_battle_ghorgon_002", "gc_orbit_90_medium_commander_front_right_close_low_01", 7000, true, false, false);
...
ga_ai_enemy_reinforcements = gb:get_army(gb:get_non_player_alliance_num(), "enemy_reinforcements");
...
--Rear Reinforcements
ga_ai_enemy_reinforcements:assign_to_spawn_zone_from_collection_on_message("start", beast_reinforcements, false);
...
-----OBJECTIVE 1-----
--???
gb:set_objective_with_leader_on_message("objective_01", "wh3_dlc27_qb_monster_hunt_18_objective_01");
gb:complete_objective_on_message("ghorgon_boss_dead", "wh3_dlc27_qb_monster_hunt_18_objective_01");
gb:remove_objective_on_message("ghorgon_boss_dead", "wh3_dlc27_qb_monster_hunt_18_objective_01", 10000);

gb:queue_help_on_message("hint_01", "wh3_dlc27_qb_monster_hunt_18_hint_01");
gb:queue_help_on_message("reinforcement_forces_in", "wh3_dlc27_qb_monster_hunt_18_hint_02");
...
gb:message_on_all_messages_received("enemy_forces_dead", "ghorgon_boss_dead", "main_force_dead", "reinforcement_force_dead")
...
ga_ai_enemy_main_boss:message_on_commander_death("ghorgon_boss_dead");

ga_ai_enemy_main_forces:attack_on_message("start");
ga_ai_enemy_main_forces:message_on_rout_proportion("main_force_hurt",0.25);
ga_ai_enemy_main_forces:message_on_rout_proportion("main_force_dead", 0.95);

ga_ai_enemy_reinforcements:reinforce_on_message("main_force_hurt");
ga_ai_enemy_reinforcements:message_on_any_deployed("reinforcement_forces_in");
ga_ai_enemy_reinforcements:rush_on_message("reinforcement_forces_in");
ga_ai_enemy_reinforcements:message_on_rout_proportion("reinforcement_force_dead",0.99);